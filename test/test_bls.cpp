...
BOOST_AUTO_TEST_CASE( ParallelSignatureRecover )
{
    ...
    BOOST_CHECK(keys->second->VerifySig(spHashArr, serial_sig));
    BOOST_CHECK(keys->second->VerifySig(spHashArr, parallel_sig));
    BOOST_CHECK(*(serial_sig->getSig()) == *(parallel_sig->getSig()));
}
